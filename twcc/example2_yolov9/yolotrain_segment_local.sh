...
echo "Activated Environment Packages:"
echo "==================="
$EXEC_ENV python -c 'import torch; print(f"PyTorch Version: {torch.__version__}")'
echo "==================="
echo "執行上一層的 env.py (測試跨節點與變數環境是否正常):"
$EXEC_ENV python ../env.py
echo "==================="
...
## 訓練 segment/train_dual.py 命令 (單節點也可以用 torchrun 讓它統一架構)
